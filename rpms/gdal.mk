...
rpmbuild/RPMS/x86_64/pdal180-1.8.0-33.x86_64.rpm: rpmbuild/SPECS/pdal.spec rpmbuild/SOURCES/PDAL-1.8.0.tar.gz rpmbuild/RPMS/x86_64/gdal231-2.3.1-33.x86_64.rpm rpmbuild/RPMS/x86_64/libgeotiff-1.4.0-33.x86_64.rpm rpmbuild/RPMS/x86_64/laszip-3.2.9-33.x86_64.rpm
	docker run -it --rm \
          -v $(shell pwd)/rpmbuild:/tmp/rpmbuild:rw \
          -v $(shell pwd)/scripts:/scripts:ro \
